...
Проект представляет собой комплексный курс из **16 лабораторных работ**, охватывающих ключевые технологии современного **NLP**, **компьютерного зрения**, **мультимодальных систем** и **прикладного ИИ**. Каждая работа построена как самостоятельное Jupyter-ноутбук с подробными объяснениями, примерами кода и практическими заданиями.
